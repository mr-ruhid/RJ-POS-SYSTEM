...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Məhsulu Redaktə Et</h1>
                <p class="text-sm text-gray-500 mt-1">{{ $product->name }} məlumatlarını yeniləyin</p>
            </div>
        ...
        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            {{-- Maya dəyəri və Vergi stokda/partiyada təyin edilir, burada dəyişmirik --}}
            <input type="hidden" name="cost_price" value="{{ $product->cost_price ?? 0 }}">
            <input type="hidden" name="tax_rate" value="{{ $product->tax_rate ?? 0 }}">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <!-- Təsvir -->
                            <div>
                                <label for="description" class="block text-sm font-medium text-gray-700 mb-1">Təsvir</label>
                                <textarea name="description" id="description" rows="3" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm transition">{{ old('description', $product->description) }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" step="0.01" name="selling_price" id="selling_price"
                                       ...
                                       required
                                       class="w-full rounded-lg border-gray-300 pl-3 pr-12 focus:border-blue-500 focus:ring-blue-500 shadow-sm transition font-bold text-gray-800 text-lg">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        @if($product->image)
                            <div class="mb-4 text-center">
                                <img src="{{ asset('storage/' . $product->image) }}" alt="Məhsul şəkli" class="h-32 w-auto mx-auto rounded-lg shadow-sm border border-gray-200 object-cover">
                                <p class="text-xs text-gray-400 mt-2">Cari şəkil</p>
                            </div>
                        @endif
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="image-upload" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="text-xs text-gray-500">Dəyişmək üçün klikləyin</p>
                                </div>
